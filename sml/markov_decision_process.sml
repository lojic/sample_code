...
(* Configuration for p. 651 in AIMA *)
val absorbing = [ (1,3,~1.0), (0,3,1.0) ] (* List of (row,col,value) for absorbing states *)
val barriers  = [ (1,1) ] (* List of invalid cells *)
val cols      = 4         (* Number of columns in grid *)                
val cost      = 0.04      (* Cost of a move *)
val delta     = 0.000001  (* Delta for use in comparing grids *)                
...
val rows      = 3         (* Number of rows in grid *)                
