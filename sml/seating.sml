...
fun reservedSeats() =
    let
      ...
      val lateArrivals    = [ (11,5),(11,6),(12,5),(12,6) ]
      val hardOfHearing   = [ (11,4) ]
    ...
    in
      [ lastSeat ] @ micVettingSeats @ signLanguage @ section1Missing @ section2Missing @ section4Missing @
      lateArrivals @ hardOfHearing @
